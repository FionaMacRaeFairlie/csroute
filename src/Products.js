...
const Products = ({ match }) => {
    const productData= [
        ...
        {name:"fish and chips",description:"locally caught ",price:"6.50",category:"main",available:"no",id:11},
        ...
        {name:"coffee",description:"freshly ground",price:"1.50",category:"drinks",available:"noyes",id:14},
